...
function Home() {
  ...
  const movies = moviesData.map((data, i) => {
    ...
    return <Movie key={i} updateLikedMovies={updateLikedMovies} isLiked={isLiked} title={data.title} overview={data.overview.substring(0,250) + "..."} poster={poster} voteAverage={data.vote_average} voteCount={data.vote_count} />;
      }
  });
